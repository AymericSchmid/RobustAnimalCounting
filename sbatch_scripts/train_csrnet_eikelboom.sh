...
#SBATCH --job-name=train_csrnet_eikelboom

PYTHON_SCRIPT=/storage/homefs/as26q834/RobustAnimalCounting/scripts/train/csrnet/train_eikelboom.py
...
DATA_ROOT=/storage/homefs/as26q834/RobustAnimalCounting/data/splits/eikelboom
LOCAL_DATA_ROOT=$TMPDIR/data/splits/eikelboom
