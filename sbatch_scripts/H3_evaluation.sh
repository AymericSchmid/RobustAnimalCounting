...
echo "=============================================================="
echo "YoloV8 Fine-tuned on Waid evaluating on Waid"
echo "=============================================================="

python scripts/eval/yolov8/evaluate.py \
    --train-dataset waid --test-dataset waid \
    --weights results/yolov8/waid/weights/best.pt --mode cross

echo "=============================================================="
echo "CSRNet Fine-tuned on Waid evaluating on Waid"
echo "=============================================================="

python scripts/eval/csrnet/evaluate.py \
    --train-dataset waid --test-dataset waid \
    --weights results/csrnet/waid/best.pth --mode cross

echo "=============================================================="
echo "YoloV8 Fine-tuned on eikelboom evaluating on Waid"
echo "=============================================================="
...
echo "=============================================================="
echo "CSRNet Fine-tuned on eikelboom evaluating on Waid"
echo "=============================================================="
