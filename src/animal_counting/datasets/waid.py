...
class WAIDDataset(BaseAnimalCountingDataset):
    """
    Wrapper for the WAID (Wildlife Aerial Images from Drone) dataset.
    ...
    This is the same format produced by preprocess_waid.py
    and matches the Eikelboom/Delplanque pattern exactly.
    """
