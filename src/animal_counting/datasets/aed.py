...
class AEDDataset(BaseAnimalCountingDataset):
    """
    Wrapper for the AED dataset.
    ...
    def _load_samples(self):
        ...
        df = pd.read_csv(
            annotation_path,
            names=["image_path", "x", "y", "species", "split"],
        )
        if self.split:
